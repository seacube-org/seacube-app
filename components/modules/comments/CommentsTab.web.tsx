    ...
    <div style={{ padding: "16px 0" }}>
      ...
      <div style={{ marginTop: 16, borderTop: `1px solid ${token.colorBorderSecondary}`, paddingTop: 12 }}>
        ...
        <Space style={{ width: "100%", justifyContent: "space-between" }}>
          <Radio.Group value={visibility} onChange={(e) => setVisibility(e.target.value)} size="small">
          ...
          <Button type="primary" size="small" onClick={handleSubmit} loading={submitting} disabled={!body.trim()}>
